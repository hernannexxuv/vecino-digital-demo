...
const DidecoDashboard = () => (
  <div className="h-64 flex items-center justify-center bg-white rounded-2xl border-2 border-dashed border-gray-200 p-6 shadow-apple">
    <div className="text-center">
      <h2 className="text-xl font-bold text-gray-800 mb-2">Panel Smart City DIDECO - Temuco</h2>
      <p className="text-sm text-gray-400 max-w-md">Aquí integraremos el consolidado de departamentos: Comunitario, Desarrollo Económico, Programas Sociales y Deportes.</p>
    </div>
  </div>
);
