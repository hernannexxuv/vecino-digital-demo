...
const SOCIOS_MOCK: Socio[] = [
  { id: 1, numero: 1, nombre: 'María González Huaiquil', rut: '12.345.678-9', domicilio: 'Av. Alemania 1420', telefono: '+56 9 8123 4567', email: 'maria.gonzalez@email.com', contactoEmergencia: 'Carlos Muñoz', telEmergencia: '+56 9 9876 5432', parentesco: 'Hija', cuotasPagadas: 6, cuotasImpagas: 2, cuotas: generarCuotas(6, 2) },
  { id: 2, numero: 2, nombre: 'Juan Cárdenas Lefián', rut: '13.456.789-0', domicilio: 'Calle Los Carrera 845', telefono: '+56 9 7234 5678', email: 'juan.cardenas@email.com', contactoEmergencia: 'Ana Soto', telEmergencia: '+56 9 8765 4321', parentesco: 'Esposa', cuotasPagadas: 8, cuotasImpagas: 0, cuotas: generarCuotas(8, 0) },
  { id: 3, numero: 3, nombre: 'Rosa Huilipán Antileo', rut: '14.567.890-1', domicilio: 'Pasaje Los Álamos 321', telefono: '+56 9 6345 6789', email: 'rosa.huilipan@email.com', contactoEmergencia: 'Pedro Rivas', telEmergencia: '+56 9 7654 3210', parentesco: 'Hermano', cuotasPagadas: 4, cuotasImpagas: 4, cuotas: generarCuotas(4, 4) },
  { id: 4, numero: 4, nombre: 'Pedro Lefián Marileo', rut: '15.678.901-2', domicilio: 'Av. Pedro de Valdivia 2100', telefono: '+56 9 5456 7890', email: 'pedro.lefian@email.com', contactoEmergencia: 'Margarita Vargas', telEmergencia: '+56 9 6543 2109', parentesco: 'Madre', cuotasPagadas: 7, cuotasImpagas: 1, cuotas: generarCuotas(7, 1) },
  { id: 5, numero: 5, nombre: 'Carmen Huaiquil Paillalef', rut: '16.789.012-3', domicilio: 'Calle Manuel Bulnes 567', telefono: '+56 9 4567 8901', email: 'carmen.huaiquil@email.com', contactoEmergencia: 'Luis Castro', telEmergencia: '+56 9 5432 1098', parentesco: 'Hijo', cuotasPagadas: 5, cuotasImpagas: 3, cuotas: generarCuotas(5, 3) },
  { id: 6, numero: 6, nombre: 'Luis Antilef Huenchullán', rut: '17.890.123-4', domicilio: 'Av. República 334', telefono: '+56 9 3678 9012', email: 'luis.antilef@email.com', contactoEmergencia: 'Patricia Mora', telEmergencia: '+56 9 4321 0987', parentesco: 'Hermana', cuotasPagadas: 9, cuotasImpagas: 0, cuotas: generarCuotas(9, 0) },
  { id: 7, numero: 7, nombre: 'Ana Marileo Carillanca', rut: '18.901.234-5', domicilio: 'Pasaje Los Sauces 123', telefono: '+56 9 2789 0123', email: 'ana.marileo@email.com', contactoEmergencia: 'Roberto Flores', telEmergencia: '+56 9 3210 9876', parentesco: 'Padre', cuotasPagadas: 3, cuotasImpagas: 5, cuotas: generarCuotas(3, 5) },
  { id: 8, numero: 8, nombre: 'Miguel Paillalef Colihuinca', rut: '19.012.345-6', domicilio: 'Calle Lautaro 890', telefono: '+56 9 1890 1234', email: 'miguel.paillalef@email.com', contactoEmergencia: 'Carmen Reyes', telEmergencia: '+56 9 2109 8765', parentesco: 'Esposo', cuotasPagadas: 6, cuotasImpagas: 2, cuotas: generarCuotas(6, 2) },
  { id: 9, numero: 9, nombre: 'Sofía Melinao Nahuelpán', rut: '20.123.456-7', domicilio: 'Av. Costanera 450', telefono: '+56 9 0901 2345', email: 'sofia.melinao@email.com', contactoEmergencia: 'Jorge Sandoval', telEmergencia: '+56 9 1098 7654', parentesco: 'Hija', cuotasPagadas: 2, cuotasImpagas: 6, cuotas: generarCuotas(2, 6) },
  { id: 10, numero: 10, nombre: 'Carlos Huenchullán Llancaleo', rut: '21.234.567-8', domicilio: 'Calle Barros Arana 1560', telefono: '+56 9 9012 3456', email: 'carlos.huenchullan@email.com', contactoEmergencia: 'María Campos', telEmergencia: '+56 9 0987 6543', parentesco: 'Madre', cuotasPagadas: 7, cuotasImpagas: 1, cuotas: generarCuotas(7, 1) },
  { id: 11, numero: 11, nombre: 'Elena Carillanca Huenul', rut: '22.345.678-9', domicilio: 'Pasaje Nahuelbuta 789', telefono: '+56 9 8123 4567', email: 'elena.carillanca@email.com', contactoEmergencia: 'Francisco Vega', telEmergencia: '+56 9 9876 5432', parentesco: 'Hermano', cuotasPagadas: 4, cuotasImpagas: 4, cuotas: generarCuotas(4, 4) },
  { id: 12, numero: 12, nombre: 'Ricardo Huenul Antinao', rut: '23.456.789-0', domicilio: 'Calle Claro Solar 234', telefono: '+56 9 7234 5678', email: 'ricardo.huenul@email.com', contactoEmergencia: 'Verónica Peña', telEmergencia: '+56 9 8765 4321', parentesco: 'Esposa', cuotasPagadas: 8, cuotasImpagas: 0, cuotas: generarCuotas(8, 0) },
  { id: 13, numero: 13, nombre: 'Patricia Llancaleo Huircán', rut: '24.567.890-1', domicilio: 'Av. Pinto 1120', telefono: '+56 9 6345 6789', email: 'patricia.llancaleo@email.com', contactoEmergencia: 'Andrés Núñez', telEmergencia: '+56 9 7654 3210', parentesco: 'Hijo', cuotasPagadas: 5, cuotasImpagas: 3, cuotas: generarCuotas(5, 3) },
  { id: 14, numero: 14, nombre: 'Héctor Nahuelpán Marileo', rut: '25.678.901-2', domicilio: 'Calle Vicuña Mackenna 670', telefono: '+56 9 5456 7890', email: 'hector.nahuelpan@email.com', contactoEmergencia: 'Isabel Torres', telEmergencia: '+56 9 6543 2109', parentesco: 'Padre', cuotasPagadas: 6, cuotasImpagas: 2, cuotas: generarCuotas(6, 2) },
  { id: 15, numero: 15, nombre: 'Marta Colihuinca Lefián', rut: '26.789.012-3', domicilio: 'Pasaje Los Lingues 456', telefono: '+56 9 4567 8901', email: 'marta.colihuinca@email.com', contactoEmergencia: 'Gabriel Muñoz', telEmergencia: '+56 9 5432 1098', parentesco: 'Hermana', cuotasPagadas: 3, cuotasImpagas: 5, cuotas: generarCuotas(3, 5) },
  { id: 16, numero: 16, nombre: 'Gabriel Marileo Huenchullán', rut: '27.890.123-4', domicilio: 'Calle San Martín 890', telefono: '+56 9 3678 9012', email: 'gabriel.marileo@email.com', contactoEmergencia: 'Sofía Pizarro', telEmergencia: '+56 9 4321 0987', parentesco: 'Hija', cuotasPagadas: 9, cuotasImpagas: 0, cuotas: generarCuotas(9, 0) },
  { id: 17, numero: 17, nombre: 'Isabel Lefián Carillanca', rut: '28.901.234-5', domicilio: 'Av. Alemania 2100', telefono: '+56 9 2789 0123', email: 'isabel.lefian@email.com', contactoEmergencia: 'Diego Herrera', telEmergencia: '+56 9 3210 9876', parentesco: 'Esposo', cuotasPagadas: 2, cuotasImpagas: 6, cuotas: generarCuotas(2, 6) },
  { id: 18, numero: 18, nombre: 'Francisco Huircán Melinao', rut: '29.012.345-6', domicilio: 'Calle Blanco Encalada 345', telefono: '+56 9 1890 1234', email: 'francisco.huircan@email.com', contactoEmergencia: 'Elena Ruiz', telEmergencia: '+56 9 2109 8765', parentesco: 'Madre', cuotasPagadas: 5, cuotasImpagas: 3, cuotas: generarCuotas(5, 3) },
  { id: 19, numero: 19, nombre: 'Verónica Antinao Paillalef', rut: '30.123.456-7', domicilio: 'Pasaje Los Robles 567', telefono: '+56 9 0901 2345', email: 'veronica.antinao@email.com', contactoEmergencia: 'Tomás Silva', telEmergencia: '+56 9 1098 7654', parentesco: 'Hermano', cuotasPagadas: 7, cuotasImpagas: 1, cuotas: generarCuotas(7, 1) },
  { id: 20, numero: 20, nombre: 'Hernán Millahual Millahual', rut: '31.234.567-8', domicilio: 'Av. Pedro de Valdivia 1850', telefono: '+56 9 9012 3456', email: 'hernan.millahual@email.com', contactoEmergencia: 'Carolina Delgado', telEmergencia: '+56 9 0987 6543', parentesco: 'Esposa', cuotasPagadas: 8, cuotasImpagas: 0, cuotas: generarCuotas(8, 0) },
];
                  ...
                  <div className="bg-amber-50/50 rounded-2xl p-4 border border-amber-100">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm font-bold text-slate-800">{socio!.contactoEmergencia} <span className="text-xs font-medium text-slate-400">({socio!.parentesco})</span></p>
                      </div>
                      <div>
